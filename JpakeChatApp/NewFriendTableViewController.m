...
- (void)viewDidLoad {
    ...
    //_ConversationRef = [[FIRDatabase database] reference];
...
//Before Delete users and any nodes
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if([segue.identifier isEqualToString:@"addedFriend"]){
        ChatVCTableViewController *chatVc = (ChatVCTableViewController *)segue.destinationViewController;
